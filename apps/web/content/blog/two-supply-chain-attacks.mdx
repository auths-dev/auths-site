...
None of these require changes to npm or PyPI themselves. They're all things individual developers, companies, or open-source projects can build today using the Auths CLI and verification library (available as a [Rust crate](https://crates.io/crates/auths-verifier), a [WASM module](https://www.npmjs.com/package/@auths-dev/verifier), and via FFI for Python, Go, and Swift).

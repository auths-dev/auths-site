 ...
 * verdict code the site may name. Ships as `conformance/verdicts.json` inside
 * `@auths-dev/sdk` (0.1.15+ exports the subpath), generated from the gateway
 * source, so the codes the site shows are pinned to the exact contract the
 * installed SDK was built from.
 */
...
export const ALL_VERDICT_CODES: ReadonlySet<string> = new Set(
  Object.values(VERDICTS).flat(),
);

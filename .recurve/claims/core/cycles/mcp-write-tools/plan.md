# Sculpting cycle: mcp-write-tools
...
| --- | --- | --- | --- | --- |
| MC-14 | core | feature | missing-surface | `mc-14.sh` |

## Smallest fixes (the SCULPT scope — keep it minimal, type-driven)

- **MC-14** — Add create_listing and my_listings tools to market-directory.mjs driving challenge -> presentation -> POST end to end.

## What gets stronger (the REBUILD payoff)

- **MC-14** unlocks: (state what gets stronger when this closes)
...
```
  ...
  ● MC-14       GREEN    closed               MCP write tools present

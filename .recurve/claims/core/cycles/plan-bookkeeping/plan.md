# Sculpting cycle: plan-bookkeeping
...
| --- | --- | --- | --- | --- |
| MC-18 | core | feature | staging | `mc-18.sh` |

## Smallest fixes (the SCULPT scope — keep it minimal, type-driven)

- **MC-18** — Retag release-scoped items owner-release per the PRD, write the A3.2 release-gate runbook note without deciding its home, reword the legend once zero ready markers remain.

## What gets stronger (the REBUILD payoff)

- **MC-18** unlocks: (state what gets stronger when this closes)
...
```
  ...
  ● MC-18       GREEN    closed               plan bookkeeping closed honestly

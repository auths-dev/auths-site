# Sculpting cycle: billing-schema
...
| --- | --- | --- | --- | --- |
| MC-21 | core | feature | missing-surface | `mc-21.sh` |

## Smallest fixes (the SCULPT scope — keep it minimal, type-driven)

- **MC-21** — Migration adding billing_accounts, fleets, settlements (every fee row cites its log_hash), keyed to the root identity.

## What gets stronger (the REBUILD payoff)

- **MC-21** unlocks: (state what gets stronger when this closes)
...
```
  ...
  ● MC-21       GREEN    closed               billing schema present and re-derivable

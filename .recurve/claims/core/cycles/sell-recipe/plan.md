...
| --- | --- | --- | --- | --- |
| MC-16 | core | feature | friction | `mc-16.sh` |

## Smallest fixes (the SCULPT scope — keep it minimal, type-driven)

- **MC-16** — Add the four-command agent path (issue market:sell credential, mint challenge, present, create listing) to /sell, every command runnable as pasted.

## What gets stronger (the REBUILD payoff)

- **MC-16** unlocks: (state what gets stronger when this closes)
...
```
  ...
  ● MC-16       GREEN    closed               sell page documents the agent path

# Sculpting cycle: discharge-goal
...
```
  ...
  ● MC-1        GREEN    open       READY→close plans closed, fleet test present and gate-wired

holding 0 · ready_to_close 1 · regressions 0 · broken 0 · stale 0 · skipped 0 · missing 0
GATE OK
```
